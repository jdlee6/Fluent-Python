...
class Vector:
    ...
    # notice how __add__ returns a NEW Vector instance and does NOT affect self or other
    def __add__(self, other):
        ...
        # a new Vector is built from the generator expression producing one sum for item in pairs
